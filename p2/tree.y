...
file
    : '[' ERRFILE STRING_QUOTED NUMB NUMB NUMB ']'
        {
...
statement
    : '[' DEFN WORD NUMB argnames expr file ']'
        {
            $$.eptr = defnode($3.strg, (int)$4.numb, $5.eptr, $6.eptr, $7.eptr);
        }
