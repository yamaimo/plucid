...
constant
    ...
    | '[' CONST '[' SPL ']'  ']'
        {
            $$.eptr = unode($4.value, 0, NULL, NULL);
        }
    ;

file
    : '[' CXFILE STRING_QUOTED NUMB NUMB NUMB ']'
        {
            $$.eptr = filenode($3.value, (int)$4.numb, (int)$5.numb, (int)$6.numb);
        }
    ;

variable
    : '[' NONNULLRY IDENT NUMB { pushexpr(); } exprlist ']'
        {
...
operator
    ...
    | '[' OP '[' INTERIOR NUMB expr expr expr ']' file ']'
        {
            $$.eptr = ternode($4.value, (int)$5.numb, $6.eptr, $7.eptr, $8.eptr, $10.eptr);
        }
    ;

valof
    : '[' VALOF { enter_phrase(); } valofbody ']'
        {
            $$.eptr = exit_phrase();
        }
    ;
